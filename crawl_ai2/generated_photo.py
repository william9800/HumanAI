...
# 关键词搜索
search_url = f"https://generated.photos/faces/asian-race"
...
# 确保保存目录存在
save_dir = "E:\crawl_data/generated"
...
def load_more_images():
    try:
        # 查找 "Load More" 按钮
        load_more_button = driver.find_element(By.CSS_SELECTOR, "button.loadmore-btn")
...
while download_count < max_images:
    ...
    for img in image_elements:
        ...
        try:
            ...
            # 过滤掉不符合尺寸的图片
            if (width, height) not in [(256,256)]:
